...
//	protected MeasureVideoView mVideoView;
//
...
//
//		mVideoView = new MeasureVideoView(this);
//		mVideoView.setId(3);
...
//					//
//					// && lTelephonyManager.getDataState() ==
...
//						// lYouTubeVideoId =
//						// YouTubeUtility.queryLatestPlaylistVideo((PlaylistId)
//						// pParams[0]);
...
//					// lUriStr =
//					// YouTubeUtility.calculateYouTubeUrl(lYouTubeFmtQuality,
...
//
//				} catch (Exception e) {
//					Log.e(this.getClass().getSimpleName(), "Error occurred while retrieving information from YouTube.",
//							e);
//				}
//				return null;
//			}
...
//						lBuilder.setTitle("setOnErrorListener");
